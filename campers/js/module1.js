  ...
  //  var RecentData = recentUser.map((name, i) => <RecentData key={i} name={name}/> )
    return (
      <div className="well">
        ...
        <div class="row"><div class="number col-xs-1"><h1>#</h1></div><div class="user col-xs-5"><h1>Camper Name</h1></div><div class="thirty col-xs-3"><h1>Past 30 Days</h1></div><div class="time col-xs-3"><h1>All Time</h1></div></div>
