  ...
  render() {
    return (
      <div>
        ...
        <div class="container">
          <div class="row">
          <div class='col-xs-6'><a href="#/recipe"><img class="thumb" src='images/recipe.png'/></a></div>
          <div class='col-xs-6'><h1>Recipe Book</h1>
          ...
          <div class="row">
          <div class='col-xs-6'><a href="http://smileawhile.github.io/d3js/"><img class="thumb" src='images/Domes.png'/></a></div>
          <div class='col-xs-6'><h1>Gross Domestic Product</h1>
          ...
          <div class="row">
          <div class='col-xs-6'><a href="#/markdown"><img class="thumb" src='images/markdown.png'/></a></div>
          <div class='col-xs-6'><h1>Markdown Previewer</h1>
          ...
          <div class="row">
          <div class='col-xs-6'><a href="#/campers"><img class="thumb" src='images/campers.png'/></a></div>
          <div class='col-xs-6'><h1>Brownie Points Leaderboard</h1>
          ...
          <div class="row">
          <div class='col-xs-6'><a href="#/quote"><img class="thumb" src='images/quote.png'/></a></div>
          <div class='col-xs-6'><h1>Random Chuck Norris Joke Generator</h1>
          ...
          <div class="row">
          <div class='col-xs-6'><a href="#/wiki"><img class="thumb" src='images/wiki.png'/></a></div>
          <div class='col-xs-6'><h1>Wikipedia Search</h1>
          ...
          <div class="row">
          <div class='col-xs-6'><a href="#/twitch"><img class="thumb" src='images/twitch.png'/></a></div>
          <div class='col-xs-6'><h1>Twitch Streamer Status</h1>
